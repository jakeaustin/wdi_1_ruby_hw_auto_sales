...
testCar = Car.new('Audi', 'R8', 2003, 30_000)
...
testDamagedCar = UsedCar.new('AMC', 'Pacer', 2003, 30_000, 10_000, damages: [testDamage])
moreDamagedCar = UsedCar.new('Land Rover', 'Sport', 2003, 30_000, 10_000, damages: [testDamage, moreDamage])
